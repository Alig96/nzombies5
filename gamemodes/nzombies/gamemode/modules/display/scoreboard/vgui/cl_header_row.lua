local headerRow = {
	Init = function( self )
		...
		self.Name:SetTextColor( nz.Display.Colours["White"] )
		...
		self.Ping:SetTextColor( nz.Display.Colours["Grey"] )
		...
		self.Headshots:SetTextColor( nz.Display.Colours["Grey"] )
		...
		self.Revives:SetTextColor( nz.Display.Colours["Grey"] )
		...
		self.Downs:SetTextColor( nz.Display.Colours["Grey"] )
		...
		self.Kills:SetTextColor( nz.Display.Colours["Grey"] )
		...
		self.Score:SetTextColor( nz.Display.Colours["Grey"] )
...
nz.Display.Vgui.SBHeaderRow = vgui.RegisterTable( headerRow, "EditablePanel" )
