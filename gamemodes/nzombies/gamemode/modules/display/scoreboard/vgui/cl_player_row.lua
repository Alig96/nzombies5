local playerRow = {
	Init = function( self )
		...
		self.Name:SetTextColor( nz.Display.Colours["Secondary"] )
		...
		self.Ping:SetTextColor( nz.Display.Colours["White"] )
		...
		self.Headshots:SetTextColor( nz.Display.Colours["Secondary"] )
		...
		self.Revives:SetTextColor( nz.Display.Colours["Secondary"] )
		...
		self.Downs:SetTextColor( nz.Display.Colours["Secondary"] )
		...
		self.Kills:SetTextColor( nz.Display.Colours["Secondary"] )
		...
		self.Score:SetTextColor( nz.Display.Colours["Secondary"] )
...
nz.Display.Vgui.SBPlayerRow = vgui.RegisterTable( playerRow, "EditablePanel" )
